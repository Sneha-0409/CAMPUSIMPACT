...
import { Mail, Lock, Eye, EyeOff, Zap, UserPlus, User } from 'lucide-react';

export default function SignupPage() {
    const router = useRouter();
    const [form, setForm] = useState({ name: '', email: '', password: '', university: 'IIT Kanpur' });
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#050508] via-[#0d0d1a] to-[#080814] px-4">
                ...
                >
                    ...
                    <p className="text-gray-400 text-sm">Check your email to verify your account, then connect your wallet.</p>
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#050508] via-[#0d0d1a] to-[#080814] px-4 py-12">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-white">Join the DAO</h1>
                    <p className="text-gray-400 mt-1 text-sm">Create your account — it&apos;s completely free</p>
                </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full pl-10 pr-4 py-3 bg-white/[0.05] border border-white/[0.1] rounded-xl text-white placeholder-gray-600 text-sm focus:outline-none focus:border-purple-500/50 transition-all"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-3 bg-white/[0.05] border border-white/[0.1] rounded-xl text-white text-sm focus:outline-none focus:border-purple-500/50 transition-all"
                            >
                                {['IIT Kanpur', 'IIT Bombay', 'IIT Delhi', 'IIT Madras', 'IIT Kharagpur', 'IIT Roorkee', 'NIT Trichy', 'BITS Pilani', 'Other'].map(u => (
                                    <option key={u} value={u} className="bg-[#0d0d1a]">{u}</option>
                                ))}
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    minLength={6}
                                    className="w-full pl-10 pr-10 py-3 bg-white/[0.05] border border-white/[0.1] rounded-xl text-white placeholder-gray-600 text-sm focus:outline-none focus:border-purple-500/50 transition-all"
                                />
